...
A GUI Visual Guide Tool for displaying coordinates on map images to help with placing/moving objects/stuff.
...
I am also planning to add more marker types.
